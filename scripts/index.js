...
function startChrono(){
    ...
    setInterval( //crée une boucle
        function(){
            ...
            // todo afficher le décompte dans la page HTML
            // todo Quand ça fait 5 secondes on affiche "dépeche toi" 
            // todo Quand ça fait 10 secondes on affiche "ça commence à être chaud" 
            // todo Quand ça fait 15 secondes on affiche "trop tard" pendant 2 secondes, puis on redirige vers la (bonne) page "perdu" 
        },
